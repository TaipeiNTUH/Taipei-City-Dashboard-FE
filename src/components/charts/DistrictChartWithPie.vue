...
<template>
	<div v-if="activeChart === 'DistrictChartWithPie'" class="districtchart">
		...
		<!-- 北投區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 34%; top: 26%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[0] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[0],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[0] }}
			</text>
		</svg>
		<!-- 北投區Pie -->

		<!-- 士林區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 48%; top: 30%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[1] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[1],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[1] }}
			</text>
		</svg>
		<!-- 士林區Pie -->

		<!-- 內湖區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 55%; top: 47%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[2] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[2],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
		...
		<!-- 松山區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 47%; top: 57%">
			<text x="23%" y="35%" style="z-index: 100000">
			...
			<circle
				...
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[3],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
		...
		<svg viewBox="0 0 64 64" class="pie" style="left: 41%; top: 57%">
			...
			<circle
				...
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[4],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[4] }}
			</text>
		</svg>
		<!-- 中山區Pie -->

		<!-- 大同區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 35%; top: 56%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[5] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[5],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[5] }}
			</text>
		</svg>
		<!-- 大同區Pie -->

		<!-- 萬華區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 32%; top: 69%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[6] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[6],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[6] }}
			</text>
		</svg>
		<!-- 萬華區Pie -->

		<!-- 中正區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 37%; top: 65%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[7] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[7],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[7] }}
			</text>
		</svg>
		<!-- 中正區Pie -->

		<!-- 大安區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 43%; top: 69%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[8] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[8],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[8] }}
			</text>
		</svg>
		<!-- 大安區Pie -->

		<!-- 信義區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 50%; top: 69%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[9] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[9],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[9] }}
			</text>
		</svg>
		<!-- 信義區Pie -->

		<!-- 南港區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 58%; top: 66%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[10] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[10],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[10] }}
			</text>
		</svg>
		<!-- 南港區Pie -->

		<!-- 文山區Pie -->
		<svg viewBox="0 0 64 64" class="pie" style="left: 51%; top: 84%">
			<text x="23%" y="35%" style="z-index: 100000">
				{{ props.chart_config.pieTextBlue[11] }}
			</text>
			<circle
				r="25%"
				cx="50%"
				cy="50%"
				:style="{
					'stroke-dasharray': props.chart_config.persentage[11],
				}"
			></circle>
			<text x="23%" y="85%" style="z-index: 100000">
				{{ props.chart_config.pieTextRed[11] }}
			</text>
		</svg>
		<!-- 文山區Pie -->
